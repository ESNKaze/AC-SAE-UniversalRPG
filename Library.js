...
function AutoCards(inHook, inText, inStop) {
    ...
    */
    ...
    const DEFAULT_GENERATED_ENTRY_LIMIT = 300
    // (200 to 2000)
    ...
    const DEFAULT_BANNED_TITLES_LIST = (
        "North, East, South, West, Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, January, February, March, April, May, June, July, August, September, October, November, December, Story Arc Settings, Current Story Arc, Story Arc, Updating Story Arc Next Turn, Generating Story Arc"
